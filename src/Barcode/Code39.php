...
class Code39 extends AbstractBarcode
{
    ...
    public function __construct(
        ...
        $this->init(strtoupper($code), $printRatio, $extended, $checksum);
     ...
     * @throws BarcodeException
     */
    private function init(string $code, float $printRatio, bool $extended, bool $checksum)
    {
        $chr = [];
        ...
        for ($i = 0; $i < $stringLength; ++$i) {
            ...
            $barArray[self::BCODE][$k] = ['t' => false, 'w' => 1, 'h' => 1, 'p' => 0];
     ...
     * @throws BarcodeException
     */
    protected function encodeExt(string $code): string
    {
        $encode = [
            chr(0) => '%U',
            chr(1) => '$A',
    ...
    {
        $chars = array_keys(self::CHARACTER_MAP);
